...
public class TestUserCreate {
    ...
    @Test
    public void testIfCanCreateUniqueUser() {
        //Arrange
        user.setName(name);
        user.setEmail(email);
    ...
    @Test
    public void testIfCanCreateNotUniqueUser() {
        //Arrange
        user.setName(name);
        user.setEmail(email);
        user.setPassword(password);
        ...
        token = response.extract().path("accessToken");
        //Act
        ValidatableResponse testResponse = ops.register(body);
    ...
    @Test
    public void testIfCanCreateUniqueUserWithInvalidRequest() {
        //Arrange
        user.setName(name);
        user.setPassword(password);
        //Act
